...
Deliberately lightweight: matplotlib, pandas, networkx and seaborn only. The
original module pulled in torch, dgl and astropy at import time, which is a slow
and fragile thing to ask of a workshop room.
"""
